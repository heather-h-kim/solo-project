...
// `INSERT INTO "cats_foods" ("cat_id", "food_id", "daily_amount_oz", "daily_amount_can", "daily_amount_cup") 
//                            VALUES ($1, $2, 

//                             (SELECT CASE WHEN "foods"."type" = 'wet'  THEN (SELECT "cats"."food_cal"*"cats"."wet_percentage"*0.01/("foods"."cal_per_kg"/35.274) FROM "cats" JOIN "cats_foods" ON "cats"."id" = "cats_foods"."cat_id"  JOIN "foods" ON "foods"."id" = "cats_foods"."food_id" WHERE "cats"."id"= $1 AND "foods"."id" =$2) 
...
//                             (SELECT CASE WHEN "foods"."type" = 'wet'  THEN (SELECT "cats"."food_cal"*"cats"."wet_percentage"*0.01/"foods"."cal_per_can" FROM "cats" JOIN "cats_foods" ON "cats"."id" = "cats_foods"."cat_id"  JOIN "foods" ON "foods"."id" = "cats_foods"."food_id" WHERE "cats"."id" = $1 AND "foods"."id" =$2) 
//                                      WHEN "foods"."type" = 'dry' THEN 0
//                                 END
//                             FROM "foods" WHERE "foods"."id" = $2) ,   

//                             (SELECT CASE WHEN "foods"."type" = 'wet'  THEN 0
